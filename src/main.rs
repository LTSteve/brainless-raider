...
fn main() {
    ...
    app.insert_resource(Msaa::Off)
        ...
        .add_plugins((
            ...
            BRMapPlugin(vec![
                String::from("maps/world1/title.tmx"),
                String::from("maps/world1/0.tmx"),
                String::from("maps/world1/1.tmx"),
                String::from("maps/world1/2.tmx"),
                String::from("maps/world1/3.tmx"),
                String::from("maps/world1/4.tmx"),
                String::from("maps/world1/youwin.tmx"),
            ]),
            CollisionPlugin {
